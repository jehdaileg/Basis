...
<html lang="en" dir="ltr">
  ...
  <body class="sidebar-fixed sidebar-dark header-light header-fixed" id="body">
    ...
    <div class="wrapper">
          ...
          =====================================
        -->
       @include('admin.body_parts.sidebar')
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="{{ asset('backend/assets/img/profiles/JehdKing.jpg') }}" class="user-image" alt="User Image" />
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li>
                        <a href="{{  route('user.update.profil') }}">
                      ...
                      <li class="dropdown-footer">
                        <a href="{{ url('user-logout') }}"> <i class="mdi mdi-logout"></i> Log Out </a>
                      </li>
                    </ul>
                  </li>
                </ul>
